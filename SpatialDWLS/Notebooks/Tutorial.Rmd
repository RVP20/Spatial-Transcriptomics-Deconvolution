...
output:
  html_document:
    df_print: paged
---
Part 1: Downloading Required Libraries and setting up path.
...
results_folder = '/Users/tanushkumar/Dropbox/ST_Project/SpatialDWLS/'
instrs = createGiottoInstructions(python_path='/Users/tanushkumar/Library/r-miniconda/envs/r-reticulate/bin/python', save_dir = results_folder,
                                  save_plot = TRUE,
                                  show_plot = FALSE)
data_path = '/Users/tanushkumar/Dropbox/ST_Project/Data'
```
```{r}
library("leiden")
library("reticulate")
...
visium_brain = createGiottoVisiumObject(visium_dir = data_path, h5_visium_path="/Users/tanushkumar/Dropbox/ST_Project/Data/filtered_feature_bc_matrix", h5_tissue_positions_path="/Users/tanushkumar/Dropbox/ST_Project/Data/tissue_positions_list.csv", h5_image_png_path="/Users/tanushkumar/Dropbox/ST_Project/Data/tissue_lowres_image.png", expr_data = 'raw',gene_column_index = 2, instructions = instrs)
