---
title: "SpatialDWLS Cell2location Exp0"
...
```
```{r}
st_data<-read_h5ad("Data/Cell2LocSimulatedData/exp0.h5ad")
...
```
```{r}
sc_data<-read_h5ad("Data/Cell2LocSimulatedData/sc_data_filtered.h5ad")
...
```
```{r}
annots<-read.csv("Data/Cell2LocSimulatedData/Ann.csv")
